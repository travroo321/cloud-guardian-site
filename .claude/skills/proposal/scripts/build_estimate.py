...
STYLES = """
  ...
  .cg-ratio{margin:14px 0 0;padding:11px 14px;border-radius:9px;font-size:.88rem;line-height:1.5;
    border:1px solid rgba(232,163,61,.5);background:rgba(232,163,61,.10);color:#e8d5b5}
  .cg-ratio:empty{display:none}
  .cg-ratio b{color:#e8a33d}
  ...
  .cg-incl,.cg-excl{border-radius:12px;padding:12px 16px;margin:18px 0 0;font-size:.9rem;line-height:1.6;border-bottom-width:1px}
  .cg-incl{border:1px solid rgba(0,212,255,.38);background:rgba(0,212,255,.07);color:#bcd8e6}
  .cg-excl{border:1px solid rgba(232,163,61,.35);background:rgba(232,163,61,.07);color:#e8d5b5}
  .cg-incl summary,.cg-excl summary{font-family:'Syne',sans-serif;font-weight:700;font-size:.9rem}
  .cg-incl summary{color:var(--cyan)}
  .cg-excl summary{color:#e8a33d}
  .cg-excl summary::after{color:#e8a33d}
  .cg-incl p,.cg-excl p{margin:0;padding:10px 26px 2px 0;font-size:.88rem;line-height:1.65;color:inherit}
  ...
  /* the long explanations fold away: header visible, body on click. Inherits the
     site's own details styling, including the + that rotates into a cross. */
  .cg-folds{margin:16px 0 0;border:1px solid var(--border);border-radius:10px;padding:0 14px;background:rgba(8,12,18,.4)}
  .cg-folds details{border-bottom:1px solid var(--border);padding:13px 0}
  .cg-folds details:last-child{border-bottom:none}
  .cg-folds summary{font-family:'Syne',sans-serif;font-weight:700;font-size:.9rem;color:#c3ced9}
  .cg-folds details[open] summary{color:var(--white)}
  .cg-folds summary:hover{color:var(--cyan)}
  .cg-folds details p{font-size:.86rem;color:#8fa0b4;line-height:1.65;padding:10px 26px 2px 0;margin:0}
